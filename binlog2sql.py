...
if __name__ == '__main__':
    ...
    if args.host == "localhost":
        conn_setting = {'host': 'localhost', 'port': args.port, 'charset': 'utf8', 'read_default_file': "/home/mysql/.{port}.cnf".format(port=args.port)}
    else:
        conn_setting = {'host': args.host, 'port': args.port, 'user': args.user, 'passwd': args.password[0], 'charset': 'utf8'}
    print conn_setting
